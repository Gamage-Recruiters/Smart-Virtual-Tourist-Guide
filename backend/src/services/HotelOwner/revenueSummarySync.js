...
const getModels = async () => {
  ...
  return {
    HotelBooking: conn.models.HotelBooking || conn.model('HotelBooking', HotelBooking.schema),
...
export const syncRevenueSummaries = async () => {
  const { HotelBooking: HotelBookingModel, Room, RevenueSummary } = await getModels();
