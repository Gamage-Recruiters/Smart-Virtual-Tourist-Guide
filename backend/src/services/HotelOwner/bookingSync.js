...
export const syncBookingToRoom = async (booking) => {
  ...
  // Both rooms and HotelBooking now store hotelId as ObjectId
  ...
  // Terminal bookings stay in HotelBooking but release all room nights.
...
/**
 * Full sync — iterates all HotelBooking documents and upserts their
