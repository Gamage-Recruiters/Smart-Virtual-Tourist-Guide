...
import { GuideAdminLayout } from "./features/guides/layouts.jsx";
import {
  ...
  PublicGuidesPage,
  RequestGuidePage,
} from "./pages/Guide/TouristPages.jsx";
import {
  GuideDashboardPage,
  GuideEarningsPage,
  GuidePackageFormPage,
  GuidePackagesPage,
  GuideSettingsPage,
  MyBidsPage,
  OpportunitiesPage,
...
} from "./pages/Guide/ProviderPages.jsx";
      ...
      <Router>
        ...
        <Route path="/add-destination" element={<AddDestination />} />
          ...
          <Route path="/dashboard-Tourist" element={<MainPage />}>
            ...
            <Route
              element={
                <ProtectedRoute allowedRoles={["tourist_user"]}>
                  <Outlet />
                </ProtectedRoute>
              }
            >
          ...
          <Route
            ...
            element={
              <ProtectedRoute allowedRoles={["guide_user"]}>
                <GuideAdminLayout />
              </ProtectedRoute>
            }
          >
