...
import Header from "../../components/Restuarant/Header";
import Footer from "../../components/Restuarant/Footer";
import heroImg from "../../assets/Restuarant/bg.jpg";
...
const RestaurantSignup = () => {
  ...
  const { handleGoogleAuth, googleLoading, googleError } = useGoogleAuth(navigate, 'restaurant_user');
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      const response = await restaurantAPI.register({
  ...
  return (
    <>
      ...
      <section className="pt-10 pb-20">
        {/* WELCOME BOX - outer transparent container, overlaps hero */}
        <div className="max-w-[1080px] mx-auto bg-blue-200/50 min-h-[980px] -mt-84 relative z-20 p-[20px] flex flex-col gap-5">
          ...
          <div className="px-4 lg:px-10 pt-10">
            ...
            <p className="mt-4 text-lg text-black max-w-[620px] pb-10">
          ...
          {/* WHITE FORM CARD - inside welcome box */}
          <div className="w-full max-w-[760px] mx-auto bg-white rounded-[30px] p-[20px] shadow-md relative z-30 mb-10">
            ...
            <form onSubmit={handleSubmit} className="space-y-5 max-w-[500px] mx-auto">
              <div>
                ...
                <input
                  ...
                  className="w-full h-[46px] bg-[#f5f7fa] rounded-md px-4 outline-none"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full h-[52px] bg-[#f5f7fa] rounded-lg px-4 outline-none"
                />
              </div>
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full max-w-[470px] h-[48px] mx-auto block rounded-full bg-[#1565ff] text-white font-semibold hover:bg-blue-700 disabled:opacity-50 transition"
              >
            ...
            {/* Divider */}
            <div className="max-w-[500px] mx-auto flex items-center my-10">
