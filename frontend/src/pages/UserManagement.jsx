  ...
  return (
    <div className="font-inter px-6 md:px-12 max-w-7xl mx-auto w-full">
      ...
      <div className="flex justify-between items-end mb-6">
        <div>
           <h2 className="text-[32px] font-bold text-[#111111]">User Management</h2>
           <p className="text-[14px] text-gray-500">Monitor and manage all user accounts.</p>
        </div>
      </div>
      ...
      <div className="flex flex-col md:flex-row justify-between items-center gap-4 mb-6">
        ...
        <button className="flex items-center justify-center gap-2 bg-[#1877F2] text-white px-6 py-3 rounded-[8px] font-medium hover:bg-blue-600 transition-colors w-full md:w-auto shadow-sm">
