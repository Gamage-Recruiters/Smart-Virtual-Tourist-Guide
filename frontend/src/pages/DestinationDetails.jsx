...
//                 className="w-full bg-[#5BA3F5] hover:bg-[#4a92e4] text-white font-semibold py-3 px-6 rounded-full transition-colors cursor-pointer shadow-sm hover:shadow-md"
//               >
//                 Book Now
//               </button>
...
const DestinationDetails = ({ destination: propDestination, onBack }) => {
  const navigate = useNavigate();
  const routerLocation = useLocation();
  const destination = propDestination || routerLocation.state?.destination;
    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center gap-4">
        ...
        <button
          ...
          className="px-6 py-2 bg-[#5BA3F5] text-white rounded-full font-medium hover:bg-[#4a92e4] transition-colors"
        >
