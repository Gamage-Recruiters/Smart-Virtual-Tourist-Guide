        ...
        >
          ...
          >
            ...
            <p className="text-sm sm:text-base font-bold text-white/90 leading-relaxed max-w-[290px] mb-8 select-none">
              ...
              <span className="opacity-80">123 KB - 6 pages</span>
            </p>

            {/* Split Download Button */}
            <button className="flex w-full items-center bg-[#18A0FB] hover:bg-blue-600 text-white font-extrabold rounded-2xl border border-white/25 overflow-hidden shadow-md transition-colors duration-300 mb-6 max-w-[280px]">
