...
import ViewCurrentRoomImg from "../../assets/HotelOwner/ViewCurrentRoomImg.png";
import del from "../../assets/HotelOwner/del.png";
import edit from "../../assets/HotelOwner/edit.png";
...
export default function ViewCurrentRoomsPackages() {
    ...
    const handleDeletePackageConfirmed = async () => {
        ...
        try {
            const res = await fetch(`http://localhost:5000/api/hotel-packages/${id}`, { method: 'DELETE' });
    ...
    useEffect(() => {
        ...
        const hotelId = userData.hotels?.[0]?._id;
        const url = hotelId
            ? `http://localhost:5000/api/hotel-packages?hotelId=${hotelId}`
            : 'http://localhost:5000/api/hotel-packages';
        fetch(url)
            .then((res) => res.json())
