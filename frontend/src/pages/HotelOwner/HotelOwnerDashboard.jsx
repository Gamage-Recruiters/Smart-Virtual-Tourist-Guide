    ...
    apiClient
      ...
      .then((res) => {
        if (res.success && res.user) {
          ...
          setHasHotel(
            Array.isArray(res.user.hotels) && res.user.hotels.length > 0,
          );
        }
      })
      .catch(() => {
        ...
        setHasHotel(
          Array.isArray(userData.hotels) && userData.hotels.length > 0,
        );
      });
  }, []);
  return (
          ...
          >
            <div className="relative z-10 flex min-h-[620px] items-center justify-center rounded-[28px] bg-white/10 px-4 py-12 text-center sm:min-h-[700px]">
              <div className="relative flex max-w-3xl flex-col items-start gap-8 text-slate-950">
                ...
                >
                  Manage Your Hotel and Boost{" "}
                  <span className="font-bold">Your</span> Booking
                </p>
                <style>{`
									@keyframes btn-shine {
                ...
                {!hasHotel && tooltipVisible && (
                  <div className="tooltip-anim absolute left-0 top-full mt-2 z-50 max-w-xs rounded-lg bg-slate-800 px-4 py-2.5 text-xs text-white shadow-lg leading-relaxed pointer-events-none">
                    Next step: Click here to add your hotel. You cannot work
                    with the system until you do.
            ...
            <div className="mx-auto max-w-[1400px]">
              <div className="mb-4 flex items-center justify-between">
                <div>
                  ...
                  <p className="mt-1 text-sm text-slate-500">
                    Manage your hotel operations and track performance
                  </p>
                </div>
                <button
                  type="button"
              ...
              <div className="grid gap-4 lg:grid-cols-[400px_1fr]">
                <aside
                  ...
                  style={{
                    background:
                      "linear-gradient(180deg, #FFFFFF 0%, #A0DBFF 100%)",
                  }}
                >
                ...
                <div
                  className="rounded-xl bg-sky-100/65 p-4"
                  style={{
                    background:
                      "linear-gradient(180deg, #FFFFFF 0%, #A0DBFF 100%)",
                  }}
                      ...
                      <div className="mt-4 flex gap-2">
                        ...
                        <div className="flex flex-1 flex-col">
                          <div className="flex h-52 items-end justify-between gap-2 rounded-md bg-slate-50 px-3 pb-3">
                            <div
                              className="w-full rounded-t-sm bg-sky-900/80"
                              style={{ height: "58%" }}
                            />
                            <div
                              className="w-full rounded-t-sm bg-sky-900/80"
                      ...
                      <div className="mt-4 flex gap-2">
                        ...
                        <div className="flex flex-1 flex-col">
                          <div className="h-52 rounded-md bg-slate-50 p-4">
                            ...
                            >
                              <path
                                d="M10 110 L95 48 L180 85 L305 15"
                                fill="none"
                                stroke="#1f8a42"
                                strokeWidth="3"
                              />
