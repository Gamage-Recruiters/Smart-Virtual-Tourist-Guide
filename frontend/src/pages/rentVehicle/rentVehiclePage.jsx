...
import { VehicleCard } from "../../components/touristRentVehicle/vehicleCard";
import { FilterInput } from "../../components/touristRentVehicle/filterInput";
import { PaginationButton } from "../../components/touristRentVehicle/paginationButton";
...
export const RentVehiclePage = () => {
  ...
  const handleViewDetails = (id) => {
    ...
    navigate(`/vehicle-details/${id}`, { state: { vehicle: selectedVehicle } });
  };
