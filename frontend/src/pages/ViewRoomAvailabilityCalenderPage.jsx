...
//   const [selectedMonthIdx, setSelectedMonthIdx] = useState(2); // 0 = Jan, 2 = March
...
//   const { label: selectedMonthLabel, days: selectedDays, startDay: selectedStartDay } = ALL_MONTHS[selectedMonthIdx];
...
//                 <FaBed className="text-slate-400" /> R{popupRoom + 1} Room's Status
//               </p>
...
//               {[...Array(selectedStartDay)].map((_, i) => <div key={`blank-${i}`} />)}
//               {[...Array(selectedDays)].map((_, dayIndex) => {
//                 const numericDay = dayIndex + 1;
//                 const structuralStatus = baseStatusPattern[(dayIndex + popupRoom) % baseStatusPattern.length];
//                 let cellStyles = "bg-green-100 text-green-700";
//                 if (structuralStatus === 'r') cellStyles = "bg-rose-100 text-rose-700 font-bold";
//                 else if (structuralStatus === 'm' || (numericDay >= 25 && (popupRoom + 1) % 3 === 0)) cellStyles = "bg-slate-200 text-slate-500";
//                 return (
//                   <div key={dayIndex} className={`py-1.5 rounded transition-colors ${cellStyles}`}>{numericDay}</div>
//                 );
//               })}
//             </div>
...
//           <option>Family Room / Quad Room</option>
//           </select>
...
//                 <div className="border border-slate-300 text-xs px-2 py-1.5 text-slate-700 bg-white">2 Adults</div>
//                 <div className="border border-slate-300 text-xs px-2 py-1.5 text-slate-700 bg-white">1 Child</div>
//               </div>
//             </div>
...
//                   <div
//                     key={i}
//                     className="aspect-square flex items-center justify-center text-lg font-medium text-slate-500 bg-[#D9F8E4]"
//                   >
//                     R{i + 1}
//                   </div>
//                 ))}
...
//           return (
//             <div key={roomIndex} onClick={() => setPopupRoom(roomIndex)} className="bg-white border border-slate-200 rounded-xl p-3 shadow-sm hover:shadow-md transition-all cursor-pointer hover:ring-2 hover:ring-sky-300">
...
//                 <FaBed className="text-slate-400" /> R{currentRoomNum} Room's Status
//               </p>
...
//                   {[...Array(selectedDays)].map((_, dayIndex) => {
//                     const numericDay = dayIndex + 1;
//                     const structuralStatus = baseStatusPattern[(dayIndex + roomIndex) % baseStatusPattern.length];
//                     let assignedCellStyles = "bg-green-100 text-green-700";
//                     if (structuralStatus === 'r') {
//                       assignedCellStyles = "bg-rose-100 text-rose-700 font-bold";
//                     } else if (structuralStatus === 'm' || (numericDay >= 25 && currentRoomNum % 3 === 0)) {
//                       assignedCellStyles = "bg-slate-200 text-slate-500 font-medium";
//                     }
//                     return (
