...
function HotelOwnerDashboard() {
	return (
		<div
			...
			style={{
				backgroundImage:
					'radial-gradient(circle at top left, rgba(217,139,66,0.16), transparent 30%), radial-gradient(circle at top right, rgba(29,95,122,0.12), transparent 28%), linear-gradient(180deg, #fffaf3 0%, #f3efe6 100%)',
			}}
		>
			<div className="mx-auto flex min-h-screen w-[min(1440px,calc(100%-1.5rem))] flex-col gap-6 py-3 sm:w-[min(1440px,calc(100%-2rem))] sm:py-4">
				<header className="grid items-center gap-5 rounded-[28px] border border-slate-200/80 bg-white/70 px-4 py-4 shadow-[0_28px_60px_rgba(20,40,60,0.12)] backdrop-blur md:grid-cols-[auto_1fr_auto] md:px-5">
					<div className="flex items-center gap-3">
						<div className="grid h-16 w-16 place-items-center rounded-[22px] bg-linear-to-br from-amber-400 to-sky-700 text-2xl font-extrabold text-white shadow-lg shadow-sky-900/20">
							<FaHotel />
						</div>
						<div>
							<p className="text-[0.78rem] font-extrabold uppercase tracking-[0.14em] text-sky-700">Smart Virtual Tourism Guide</p>
							<h1 className="text-xl font-extrabold text-slate-800 sm:text-2xl">Sri Lanka Hotel Dashboard</h1>
						</div>
					</div>

					<nav className="flex flex-wrap items-center justify-start gap-4 text-sm font-bold text-slate-500 md:justify-center">
						<a className="transition hover:text-sky-800" href="#overview">Overview</a>
						<a className="transition hover:text-sky-800" href="#rooms">Rooms</a>
					...
					<div className="flex flex-wrap items-center gap-3 md:justify-end">
						...
						<div className="flex items-center gap-3 rounded-full border border-slate-200 bg-white px-2 py-2 shadow-sm">
							<div className="grid h-9 w-9 place-items-center rounded-full bg-linear-to-br from-amber-100 to-amber-400 text-slate-900">
								<FaUserLarge />
							</div>
							<div className="pr-2 leading-tight">
								<strong className="block text-sm text-slate-800">Thilini</strong>
								<p className="m-0 text-xs text-slate-500">Hotel owner</p>
							</div>
						</div>
					</div>
				</header>
				...
				<main className="flex flex-1 flex-col gap-6">
					<section
						id="overview"
						className="grid gap-6 overflow-hidden rounded-[36px] border border-slate-200/80 bg-white/25 p-5 shadow-[0_28px_60px_rgba(20,40,60,0.12)] backdrop-blur md:grid-cols-[1.35fr_0.9fr] md:p-10"
						style={{
							backgroundImage:
								'linear-gradient(180deg, rgba(255,255,255,0.35), rgba(255,255,255,0.2)), linear-gradient(160deg, rgba(53,120,146,0.15), rgba(255,255,255,0.2)), url(https://images.unsplash.com/photo-1500375592092-40eb2168fd21?auto=format&fit=crop&w=1600&q=80)',
					...
					<section className="grid gap-6 rounded-[30px] border border-sky-100 bg-sky-100/80 p-4 shadow-[0_24px_50px_rgba(20,40,60,0.08)] lg:grid-cols-[300px_1fr] lg:p-5">
					...
					<section className="rounded-[28px] border border-slate-200 bg-white/70 p-6 shadow-sm backdrop-blur" aria-label="Latest reservations">
