...
const MOCK_REVIEWS = {
  a1: [
    ...
    {
      _id: 'r5',
      touristName: 'Aiko Tanaka',
      touristCountry: 'Japan',
      rating: 5,
      title: '最高の体験！(Best experience!)',
      body: 'We visited from Japan and were amazed by the variety of animals. The guide spoke excellent English and was very patient with us. Will definitely return.',
      helpfulYes: 15,
      helpfulNo: 0,
      visitDate: '01 Feb 2026',
    ...
    },
    {
      ...
      touristCountry: 'India',
      rating: 2,
      title: 'Disappointing — too crowded',
      body: 'Unfortunately there were too many jeeps which scared away most animals. We only saw deer and a distant elephant. The guide tried his best though.',
      helpfulYes: 3,
      helpfulNo: 5,
  ...
  a2: [
    {
      _id: 'r8',
      touristName: 'Tom Baker',
      touristCountry: 'Australia',
      rating: 5,
      title: 'Learned to surf in 2 hours!',
      body: 'I had never surfed before and by the end of the session I was standing up on waves. The instructors are incredibly patient and skilled. Weligama is the perfect beginner beach.',
      helpfulYes: 18,
      helpfulNo: 0,
      visitDate: '20 Mar 2026',
      createdAt: '2026-03-25T08:00:00Z',
    },
    {
      _id: 'r9',
      touristName: 'Lisa Johansson',
      touristCountry: 'Sweden',
      rating: 5,
      title: 'Perfect surf school',
      body: 'The equipment was top quality and the instructors really know how to teach. Small group sizes mean you get a lot of personal attention.',
      helpfulYes: 11,
      helpfulNo: 0,
    ...
    },
    {
      ...
      body: 'Fun and professional. The beach is beautiful and the waves are perfect for beginners. Would have liked slightly longer session time.',
      helpfulYes: 6,
      helpfulNo: 1,
      visitDate: '10 Mar 2026',
  ...
  a3: [
    {
      ...
      rating: 5,
      title: 'A true wonder of the world',
      body: 'Climbing Sigiriya was one of the most memorable experiences of my life. The frescoes, the lion paws, the view from the top — everything was spectacular. Our guide was a historian at heart.',
      helpfulYes: 25,
      helpfulNo: 0,
      visitDate: '08 Mar 2026',
    ...
    },
    {
      ...
      touristCountry: 'UAE',
      rating: 4,
      title: 'Magnificent ancient fortress',
      body: 'The history behind Sigiriya is fascinating. Going early morning helps avoid crowds. The climb is quite steep so wear good shoes and bring water.',
      helpfulYes: 14,
      helpfulNo: 0,
      visitDate: '02 Mar 2026',
      createdAt: '2026-03-06T08:00:00Z',
    },
    {
      _id: 'r13',
      touristName: 'Mei Chen',
      touristCountry: 'Singapore',
      rating: 3,
      title: 'Historic but very hot and crowded',
      body: 'The rock fortress itself is impressive and the views are stunning. However we visited midday and it was extremely hot and crowded. Go at sunrise if possible.',
      helpfulYes: 7,
      helpfulNo: 2,
      visitDate: '25 Feb 2026',
