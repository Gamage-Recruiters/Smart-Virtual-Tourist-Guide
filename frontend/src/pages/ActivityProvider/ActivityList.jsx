  ...
  const fetchActivities = useCallback(
    async (page = 1) => {
      try {
        ...
        const res =
          await activityAPI.getAll(params);
    ...
    <div className="min-h-screen bg-slate-100 flex">
      ...
      {deleteTarget && (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="bg-white rounded-lg shadow-lg z-50 w-full max-w-md p-6">
            ...
            <p className="text-sm text-gray-600 mb-4">Are you sure you want to delete "{deleteTarget.title}"? This action cannot be undone.</p>
      ...
      <div className="bg-gradient-to-r from-[#264653] via-[#2d6a4f] to-[#1a6fdb] px-7 py-6 text-white">
        ...
        <p className="text-sm opacity-80 mt-1">
          Manage and publish your tourism
          activities
        </p>
      </div>
      ...
      <div className="flex-1 px-6 py-5">
        ...
        <div className="flex flex-wrap items-center justify-between gap-3 mb-4">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <button
              onClick={() =>
                navigate('/activityprovider/activities/new')
              }
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <p className="text-xs text-gray-500 mb-1">
                    <FiMapPin className="inline w-3 h-3 mr-1 align-text-bottom" style={{ color: ICON_COLORS.primary }} /> {a.location} · <FiClock className="inline w-3 h-3 mx-1 align-text-bottom" style={{ color: ICON_COLORS.publish }} /> {a.duration}
                  </p>

                  <p className="text-xs text-gray-500 mb-2">
                    <FiUsers className="inline w-3 h-3 mr-1 align-text-bottom" style={{ color: ICON_COLORS.success }} /> Max {a.maxParticipants} participants
                  </p>
                  ...
                  <div className="flex items-center justify-between mt-2">
                    <span className="text-sm font-semibold text-blue-600">
                      LKR{' '}
                      {a.pricePerPerson?.toLocaleString()}
                    </span>
                ...
                <div className="flex border-t border-gray-100">
                        <button
                          onClick={() =>
                            navigate(
                              `/activityprovider/activities/edit/${a._id}`
                            )
                          }
