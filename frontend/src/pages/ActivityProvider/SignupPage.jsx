...
import { activityProviderAPI } from "../../services/api";
import Header from "../../components/ActivityProvider/Header";
import Footer from "../../components/ActivityProvider/Footer";
import heroImg from "../../assets/ActivityProvider/bg.png";
...
const ActivityProviderSignup = () => {
  ...
  const { handleGoogleAuth, googleLoading, googleError } = useGoogleAuth(navigate, 'activityprovider_user');
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      const response = await activityProviderAPI.register({
        ...
        <div className="max-w-[1080px] mx-auto bg-blue-200/50 min-h-[980px] -mt-84 relative z-20 p-[20px] flex flex-col gap-5">
          ...
          <div className="px-4 lg:px-10 pt-10">
            <h1 className="text-[38px] font-bold text-black leading-tight">
              Welcome Smart Virtual Activity Provider Section
            </h1>

            <p className="mt-4 text-lg text-black max-w-[920px] pb-10">
              The definitive management console for activity providers. Elevate your 
          ...
          <div className="w-full max-w-[760px] mx-auto bg-white rounded-[30px] p-[20px] shadow-md relative z-30 mb-10">
            ...
            <div className="text-center mb-10">
              ...
              <p className="mt-3 text-gray-500">
                Start managing your activity provider business with professional precision.
              </p>
              {error && (
