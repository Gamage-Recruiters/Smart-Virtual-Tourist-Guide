        ...
        <div className="relative flex flex-col items-center font-sans overflow-hidden bg-slate-50">
          ...
          <div className="relative z-20 w-full max-w-5xl px-6 pt-[20vh] pb-12 flex flex-col items-center">
            <div className="rounded-3xl bg-[#bce0fd]/85 p-6">
              ...
              <div className="bg-white p-8 md:px-15 rounded-3xl shadow-2xl w-full max-w-xl mx-auto mb-10">
                ...
                >
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <button
                      type="button"
                      className="flex items-center justify-center gap-2 border border-slate-200 rounded-xl py-2.5 px-4 text-sm font-bold text-slate-600 hover:bg-slate-50 transition-colors cursor-pointer"
                    >
