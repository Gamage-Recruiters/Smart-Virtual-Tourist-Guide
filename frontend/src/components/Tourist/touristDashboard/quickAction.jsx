...
export default function QuickAction({ icon, label, location }) {
  ...
  return(
    <button className="bg-white border border-slate-200 p-4 rounded-2xl flex flex-col items-center justify-center gap-2  hover:bg-blue-50 transition-all group h-30" onClick={()=>navigate(location)}>
