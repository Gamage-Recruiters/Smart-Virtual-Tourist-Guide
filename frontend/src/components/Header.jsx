...
function Header() {
    return (
        <header className="relative grid items-center gap-5 border border-slate-200/80 bg-white/70 px-4 py-4 shadow-[0_28px_60px_rgba(20,40,60,0.12)] backdrop-blur md:grid-cols-[auto_1fr_auto] md:px-5">
