...
const FooterColumn = ({ title, links, style }) => (
  <div style={{ display: "flex", flexDirection: "column", ...style }}>
    ...
    >
      {links.map((link, idx) => (
        <li key={idx} style={{ display: "flex", alignItems: "center", marginBottom: idx === links.length - 1 ? 0 : "10px" }}>
          <span style={{ color: "#122E63", fontSize: "1em", marginRight: "10px" }}>&#9679;</span>
          <a href={link.href || "#"} style={{ color: "#22223b", textDecoration: "none", whiteSpace: "nowrap" }}>{link.label}</a>
        </li>
      ))}
    </ul>
  </div>
      ...
      >
        ...
        <FooterColumn 
          ...
          links={[
            ...
            { label: "FAQ" },
            { label: "Travel Safety Guidelines" }
          ]}
          style={{ marginLeft: "102px" }}
        />
